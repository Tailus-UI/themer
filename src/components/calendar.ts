    ...
    variants: {
        range: {
            true: {
                ...
                month: "relative last:before:hidden before:absolute before:-inset-y-[--popover-padding] before:-right-4 before:w-0.5 before:border-r before:bg-gray-white dark:before:bg-gray-950 dark:before:border-gray-800 before:mx-auto",
                table: "space-y-0",
                head_cell: "gap-0",
                head_row: "gap-0",
                row: "mt-0 gap-0",
