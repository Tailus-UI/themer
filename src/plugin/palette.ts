...
export const palettePlugin = plugin(
    ({ addBase }) => {
        addBase({
            ":root": {
            ...
            '[data-palette="trust"]': {
                ...
                "--colors-secondary-50": "var(--colors-indigo-50)",
                "--colors-secondary-100": "var(--colors-indigo-100)",
                "--colors-secondary-200": "var(--colors-indigo-200)",
                "--colors-secondary-300": "var(--colors-indigo-300)",
                "--colors-secondary-400": "var(--colors-indigo-400)",
                "--colors-secondary-500": "var(--colors-indigo-500)",
                "--colors-secondary-600": "var(--colors-indigo-600)",
                "--colors-secondary-700": "var(--colors-indigo-700)",
                "--colors-secondary-800": "var(--colors-indigo-800)",
                "--colors-secondary-900": "var(--colors-indigo-900)",
                "--colors-secondary-950": "var(--colors-indigo-950)",

                "--colors-accent-50": "var(--colors-violet-50)",
                "--colors-accent-100": "var(--colors-violet-100)",
                "--colors-accent-200": "var(--colors-violet-200)",
                "--colors-accent-300": "var(--colors-violet-300)",
                "--colors-accent-400": "var(--colors-violet-400)",
                "--colors-accent-500": "var(--colors-violet-500)",
                "--colors-accent-600": "var(--colors-violet-600)",
                "--colors-accent-700": "var(--colors-violet-700)",
                "--colors-accent-800": "var(--colors-violet-800)",
                "--colors-accent-900": "var(--colors-violet-900)",
                "--colors-accent-950": "var(--colors-violet-950)",
