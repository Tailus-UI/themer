const item = "overflow-hidden transition duration-300 data-[state=open]:z-10";

const trigger = {
    parent: {
        base: "group flex w-full items-center justify-between rounded-[--accordion-border-radius] py-4 text-lg",
        appearances: {
            light: "text-gray-900",
            dark: "text-white",
