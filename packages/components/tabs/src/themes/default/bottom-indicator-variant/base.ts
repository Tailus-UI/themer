...
const baseTrigger = {
    base: "block relative rounded-[--tabs-border-radius] px-2 h-8 flex gap-2 items-center justify-center leading-none select-none cursor-pointer",
    appearances: {
        light: "text-gray-700 hover:bg-[--tabs-light-bg] data-[state=active]:text-gray-900",
        dark: "text-gray-300 hover:bg-[--tabs-dark-bg] data-[state=active]:text-white",
        both: "text-gray-700 hover:bg-[--tabs-light-bg] dark:text-gray-300 dark:hover:bg-[--tabs-dark-bg] data-[state=active]:text-gray-900 dark:data-[state=active]:text-white",
    },
};
...
const baseIndicator = {
    ...
    appearances: {
        light: "bg-[--tabs-indicator-light-bg]",
        dark: "bg-[--tabs-indicator-dark-bg]",
        both: "bg-[--tabs-indicator-light-bg] dark:bg-[--tabs-indicator-dark-bg]",
    },
};
